  ...
  memoTheme(({ theme }) => {
    ...
    return {
      ...
      variants: [
        {
          props: { size: 'small' },
          style: { borderRadius: theme.size.small.borderRadius },
        },
        {
          props: { size: 'large' },
          style: { borderRadius: theme.size.large.borderRadius },
        },
        ...
        },
        {
          ...
          style: {
            paddingLeft: theme.size.medium.paddingX,
          },
        },
        {
          props: ({ ownerState }) => ownerState.endAdornment,
          style: {
            paddingRight: theme.size.medium.paddingX,
          },
        },
        {
