...
const FilledInputRoot = styled(InputBaseRoot, {
  ...
  memoTheme(({ theme }) => {
    ...
    const backgroundColor = light ? 'rgba(0, 0, 0, 0.10)' : 'rgba(255, 255, 255, 0.09)';
    ...
    return {
      ...
      variants: [
        ...
        },
        {
          ...
          style: {
            padding: `${(theme.size.medium.height - theme.size.medium.fontSize) / 2}px ${theme.size.medium.paddingX}px`,
          },
        },
        {
