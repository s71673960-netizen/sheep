...
const DialogContentRoot = styled('div', {
  ...
  memoTheme(({ theme }) => ({
    ...
    padding: '0 24px',
    scrollbarWidth: 'thin',
    scrollbarColor: 'var(--dialog-content-scrollbar-thumb) transparent',
    '&::-webkit-scrollbar': {
      width: 4,
      height: 4,
    },
    '&::-webkit-scrollbar-thumb': {
      backgroundColor: 'var(--dialog-content-scrollbar-thumb)',
      borderRadius: 4,
      '&:hover': {
        backgroundColor: 'var(--dialog-content-scrollbar-thumb-hover)',
      },
      '&:active': {
        backgroundColor: 'var(--dialog-content-scrollbar-thumb-active)',
      },
    },
