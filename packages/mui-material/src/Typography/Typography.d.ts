...
export interface TypographyOwnProps {
  ...
  variantMapping?:
    | Partial<
      ...
      >
    | undefined;
  // Common system props for backward compat with MUI v5/v6
  display?: React.CSSProperties['display'] | undefined;
  fontWeight?: React.CSSProperties['fontWeight'] | undefined;
  fontSize?: React.CSSProperties['fontSize'] | number | string | undefined;
  letterSpacing?: React.CSSProperties['letterSpacing'] | number | string | undefined;
  lineHeight?: React.CSSProperties['lineHeight'] | number | string | undefined;
