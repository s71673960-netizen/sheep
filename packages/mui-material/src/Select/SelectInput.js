...
const SelectSelect = styled(StyledSelectSelect, {
  ...
  memoTheme(({ theme }) => ({
    [`&.${selectClasses.select}`]: {
      ...
      padding: `0 32px 0 ${theme.size.medium.paddingX}px`,
    ...
    [`&.${selectClasses.multiple}`]: {
      height: 'auto',
      minHeight: theme.size.medium.height,
      whiteSpace: 'normal',
    },
    variants: [
      {
        ...
        style: {
          [`&.${selectClasses.select}`]: {
            ...
            padding: `0 32px 0 ${theme.size.small.paddingX}px`,
      ...
      },
      {
        ...
        style: {
          [`&.${selectClasses.select}`]: {
            ...
            padding: `0 32px 0 ${theme.size.large.paddingX}px`,
            fontSize: theme.typography.pxToRem(theme.size.large.fontSize),
          },
          [`&.${selectClasses.multiple}`]: {
            minHeight: theme.size.large.height,
          },
        },
      },
    ],
