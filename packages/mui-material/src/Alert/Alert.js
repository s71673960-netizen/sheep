      ...
      variants: [
        ...
        ...Object.entries(theme.palette)
          ...
          .map(([color]) => ({
            ...
            style: {
              color: theme.palette[color].main,
              border: `1px solid ${theme.palette[color].border || (theme.vars || theme).palette[color].light}`,
              [`& .${alertClasses.icon}`]: {
                color: theme.palette[color].main,
              },
            },
...
const Alert = React.forwardRef(function Alert(inProps, ref) {
  ...
  const severity = type || severityProp;
...
Alert.propTypes /* remove-proptypes */ = {
  ...
  /**
   * Alias for severity. When both are provided, type takes priority.
   */
