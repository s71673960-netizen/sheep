...
const AutocompleteListbox = styled(Scrollbar, {
  name: 'MuiAutocomplete',
  slot: 'Listbox',
})(
  memoTheme(({ theme }) => ({
...
const Autocomplete = React.forwardRef(function Autocomplete(inProps, ref) {
  ...
  const [ListboxSlot, listboxProps] = useSlot('listbox', {
    ...
    additionalProps: { ...otherListboxProps, component: 'ul' },
    ref: listboxRef,
  });
    ...
    <React.Fragment>
      ...
      {anchorEl ? (
        <AutocompletePopper as={PopperSlot} {...popperProps}>
          <Grow in={popupOpen && hasPopupContent} style={{ transformOrigin: '0 0 0' }} timeout={300}>
