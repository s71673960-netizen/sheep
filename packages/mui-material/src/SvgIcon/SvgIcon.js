...
const SvgIconRoot = styled('svg', {
  ...
  memoTheme(({ theme }) => ({
    ...
    variants: [
      ...
      {
        props: { fontSize: 'xs' },
        style: { fontSize: theme.typography?.pxToRem?.(12) || '0.75rem' },
      },
      {
        props: { fontSize: 'small' },
        style: { fontSize: theme.typography?.pxToRem?.(14) || '0.875rem' },
      },
      {
        props: { fontSize: 'medium' },
        style: { fontSize: theme.typography?.pxToRem?.(16) || '1rem' },
      },
      {
        props: { fontSize: 'large' },
        style: { fontSize: theme.typography?.pxToRem?.(18) || '1.125rem' },
      },
      {
        props: { fontSize: 'xl' },
        style: { fontSize: theme.typography?.pxToRem?.(26) || '1.625rem' },
      },
...
SvgIcon.propTypes /* remove-proptypes */ = {
  ...
  fontSize: PropTypes /* @typescript-to-proptypes-ignore */.oneOfType([
    PropTypes.oneOf(['inherit', 'large', 'medium', 'small', 'xs', 'xl']),
    PropTypes.string,
  ]),
  /**
