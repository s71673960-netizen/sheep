...
const DrawerPaper = styled(Paper, {
  ...
  memoTheme(({ theme }) => ({
    ...
    outline: 0,
    scrollbarWidth: 'thin',
    scrollbarColor: 'var(--drawer-scrollbar-thumb) transparent',
    '&::-webkit-scrollbar': {
      width: 4,
      height: 4,
    },
    '&::-webkit-scrollbar-thumb': {
      backgroundColor: 'var(--drawer-scrollbar-thumb)',
      borderRadius: 4,
      '&:hover': {
        backgroundColor: 'var(--drawer-scrollbar-thumb-hover)',
      },
      '&:active': {
        backgroundColor: 'var(--drawer-scrollbar-thumb-active)',
      },
    },
    ...
    variants: [
      {
        props: ({ ownerState }) => ownerState.variant === 'temporary',
        style: {
          boxShadow:
