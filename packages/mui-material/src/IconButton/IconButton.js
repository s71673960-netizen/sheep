...
const IconButtonRoot = styled(ButtonBase, {
  ...
  memoTheme(({ theme }) => ({
    ...
    '&::after': {
      ...
      opacity: 0,
      boxShadow: '0 0 0 6px var(--IconButton-waveColor, currentColor)',
      transition: 'opacity 0.4s, box-shadow 0.4s',
      pointerEvents: 'none',
    },
    '&:active::after': {
      opacity: 0.2,
      boxShadow: '0 0 0 0px var(--IconButton-waveColor, currentColor)',
      transition: '0s',
    },
    variants: [
      {
      ...
      },
      {
        props: { edge: 'start' },
        style: {
          marginLeft: -(theme.size.medium.height - theme.size.medium.iconSize) / 2,
        },
      },
      {
        props: { edge: 'start', size: 'small' },
        style: {
          marginLeft: -(theme.size.small.height - theme.size.small.iconSize) / 2,
        },
      },
      {
        props: { edge: 'end' },
        style: {
          marginRight: -(theme.size.medium.height - theme.size.medium.iconSize) / 2,
        },
      },
      {
        props: { edge: 'end', size: 'small' },
        style: {
          marginRight: -(theme.size.small.height - theme.size.small.iconSize) / 2,
        },
      },
    ],
  })),
