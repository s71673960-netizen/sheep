...
const ButtonRoot = styled(ButtonBase, {
  ...
  memoTheme(({ theme }) => {
    ...
    return {
      ...
      minWidth: 64,
      padding: `0 ${theme.size.medium.paddingX}px`,
      height: theme.size.medium.height,
      fontSize: theme.typography.pxToRem(theme.size.medium.fontSize),
      border: 0,
      borderRadius: theme.size.medium.borderRadius,
      position: 'relative',
      ...
      '&::after': {
        ...
        opacity: 0,
        boxShadow: '0 0 0 6px var(--variant-containedBg, currentColor)',
        transition: 'opacity 0.4s, box-shadow 0.4s',
        pointerEvents: 'none',
      },
      '&:active::after': {
        opacity: 0.3,
        boxShadow: '0 0 0 0px var(--variant-containedBg, currentColor)',
        transition: '0s',
      },
      ...
      variants: [
        ...
        },
        {
          ...
          style: {
            ...
            [`&.${buttonClasses.disabled}`]: {
              ...
              boxShadow: 'none',
              backgroundColor: (theme.vars || theme).palette.primary.disabled || (theme.vars || theme).palette.action.disabledBackground,
            },
          },
        },
        {
          ...
          style: {
            padding: '5px 15px',
            border: `1px solid var(--variant-outlinedBorder, ${(theme.vars || theme).palette.divider})`,
            backgroundColor: 'transparent',
            color: `var(--variant-outlinedColor, ${(theme.vars || theme).palette.text.primary})`,
            '&:hover': {
              color: `var(--variant-outlinedColor, ${(theme.vars || theme).palette.primary.main})`,
              borderColor: `var(--variant-outlinedBorder, ${(theme.vars || theme).palette.primary.main})`,
              backgroundColor: 'transparent',
            },
            [`&.${buttonClasses.disabled}`]: {
              border: `1px solid ${(theme.vars || theme).palette.primary.disabled || (theme.vars || theme).palette.action.disabledBackground}`,
              color: (theme.vars || theme).palette.primary.disabled || (theme.vars || theme).palette.action.disabled,
            },
          },
        },
        {
          ...
          style: {
            ...
            '&:hover': {
              color: (theme.vars || theme).palette.primary.hover || (theme.vars || theme).palette.primary.main,
              borderColor: (theme.vars || theme).palette.primary.hover || (theme.vars || theme).palette.primary.main,
              backgroundColor: 'transparent',
            },
            [`&.${buttonClasses.disabled}`]: {
              border: `1px dashed ${(theme.vars || theme).palette.primary.disabled || (theme.vars || theme).palette.action.disabledBackground}`,
              color: (theme.vars || theme).palette.primary.disabled || (theme.vars || theme).palette.action.disabled,
            },
          },
        },
          ...
          .map(([color]) => ({
            ...
            style: {
              ...
              '--variant-outlinedBorder':
                (theme.vars || theme).palette[color].border ||
                theme.alpha((theme.vars || theme).palette[color].main, 0.5),
              '--variant-containedColor': (theme.vars || theme).palette[color].contrastText,
              '--variant-containedBg': (theme.vars || theme).palette[color].main,
              '@media (hover: hover)': {
                '&:hover': {
                  '--variant-containedBg': (theme.vars || theme).palette[color].hover || (theme.vars || theme).palette[color].dark,
          ...
          .map(([color]) => ({
            ...
            style: {
              [`&.${buttonClasses.disabled}`]: {
                ...
                backgroundColor: (theme.vars || theme).palette[color].disabled || (theme.vars || theme).palette.action.disabledBackground,
              },
            },
          })),
        {
        ...
        },
        {
          ...
          style: {
            padding: `0 ${theme.size.small.paddingX}px`,
            height: theme.size.small.height,
            fontSize: theme.typography.pxToRem(theme.size.small.fontSize),
            borderRadius: theme.size.small.borderRadius,
          },
        },
        {
          props: {
          ...
          style: {
            padding: `0 ${theme.size.large.paddingX}px`,
            height: theme.size.large.height,
            fontSize: theme.typography.pxToRem(theme.size.large.fontSize),
            borderRadius: theme.size.large.borderRadius,
          },
        },
        {
          props: {
