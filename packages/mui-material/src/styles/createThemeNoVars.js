...
import sizeTokens from '../tokens/generated/size';
import spacingTokens from '../tokens/generated/spacing';
import shapeTokens from '../tokens/generated/shape';
...
function createThemeNoVars(options = {}, ...args) {
  const {
    ...
    mixins: mixinsInput = {},
    spacing: spacingInput = spacingTokens.unit,
    palette: paletteInput = {},
    transitions: transitionsInput = {},
    typography: typographyInput = {},
    shape: shapeInput = shapeTokens,
    colorSpace,
    ...other
  } = options;
  ...
  let muiTheme = deepmerge(systemTheme, {
    ...
    zIndex: { ...zIndex },
    size: sizeTokens,
    spacingScales: spacingTokens.scales,
  });
