...
export default function createThemeWithVars(options = {}, ...args) {
  ...
  Object.keys(theme.colorSchemes).forEach((key) => {
    ...
    if (palette.mode === 'light') {
      ...
      setColor(palette.Alert, 'errorFilledBg', setCssVarColor('palette-error-light'));
      setColor(palette.Alert, 'infoFilledBg', setCssVarColor('palette-info-light'));
      setColor(palette.Alert, 'successFilledBg', setCssVarColor('palette-success-light'));
      setColor(palette.Alert, 'warningFilledBg', setCssVarColor('palette-warning-light'));
      setColor(palette.Alert, 'errorFilledColor', setCssVarColor('palette-error-dark'));
      setColor(palette.Alert, 'infoFilledColor', setCssVarColor('palette-info-dark'));
      setColor(palette.Alert, 'successFilledColor', setCssVarColor('palette-success-dark'));
      setColor(palette.Alert, 'warningFilledColor', setCssVarColor('palette-warning-dark'));
      setColor(
        palette.Alert,
        'errorStandardBg',
        colorMix(
      ...
      setColor(palette.FilledInput, 'bg', 'rgba(0, 0, 0, 0.10)');
