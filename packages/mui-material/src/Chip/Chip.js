...
import CancelIcon from '../internal/svg-icons/CancelOutlined';
      ...
      variants: [
        ...
        },
        {
          ...
          style: {
            ...
            [`& .${chipClasses.icon}`]: {
              fontSize: theme.size.large.iconSize,
            },
            [`& .${chipClasses.deleteIcon}`]: {
              fontSize: theme.size.large.iconSize,
            },
        ...
        ...Object.entries(theme.palette)
          ...
          .filter(([color]) => color !== 'primary' && color !== 'secondary' && color !== 'success' && color !== 'error' && color !== 'warning' && color !== 'info')
          .flatMap(([color]) => {
            ...
            return [
              {
                props: { color },
                style: {
                  backgroundColor: palette.bgcolor || palette.main,
                  color: palette.bgcolor ? palette.main : palette.contrastText,
                  [`& .${chipClasses.deleteIcon}`]: {
                    color: palette.bgcolor ? palette.main : theme.alpha(palette.contrastText, 0.7),
                    '&:hover, &:active': {
                      color: palette.bgcolor ? palette.dark : palette.contrastText,
                    },
                  },
                },
              },
              {
                props: { color, bordered: true },
                style: {
                  border: `1px solid ${palette.border || palette.main}`,
                },
              },
            ];
          }),
        {
          props: { color: 'primary' },
          style: {
            backgroundColor: (theme.vars || theme).palette.primary.bgcolor || (theme.vars || theme).palette.primary.light,
        ...
        {
          props: { color: 'primary', bordered: true },
          style: {
            border: `1px solid ${(theme.vars || theme).palette.primary.border || (theme.vars || theme).palette.primary.main}`,
          },
        },
        {
          props: { color: 'secondary' },
          style: {
            backgroundColor: (theme.vars || theme).palette.secondary.bgcolor || (theme.vars || theme).palette.secondary.light,
        ...
        {
          props: { color: 'secondary', bordered: true },
          style: {
            border: `1px solid ${(theme.vars || theme).palette.secondary.border || (theme.vars || theme).palette.secondary.main}`,
          },
        },
        {
          props: { color: 'success' },
          style: {
            backgroundColor: (theme.vars || theme).palette.success.bgcolor || (theme.vars || theme).palette.success.light,
        ...
        {
          props: { color: 'success', bordered: true },
          style: {
            border: `1px solid ${(theme.vars || theme).palette.success.border || (theme.vars || theme).palette.success.main}`,
          },
        },
        {
          props: { color: 'error' },
          style: {
            backgroundColor: (theme.vars || theme).palette.error.bgcolor || (theme.vars || theme).palette.error.light,
        ...
        {
          props: { color: 'error', bordered: true },
          style: {
            border: `1px solid ${(theme.vars || theme).palette.error.border || (theme.vars || theme).palette.error.main}`,
          },
        },
        {
          props: { color: 'warning' },
          style: {
            backgroundColor: (theme.vars || theme).palette.warning.bgcolor || (theme.vars || theme).palette.warning.light,
        ...
        {
          props: { color: 'warning', bordered: true },
          style: {
            border: `1px solid ${(theme.vars || theme).palette.warning.border || (theme.vars || theme).palette.warning.main}`,
          },
        },
        {
          props: { color: 'info' },
          style: {
            backgroundColor: (theme.vars || theme).palette.info.bgcolor || (theme.vars || theme).palette.info.light,
        ...
        {
          props: { color: 'info', bordered: true },
          style: {
            border: `1px solid ${(theme.vars || theme).palette.info.border || (theme.vars || theme).palette.info.main}`,
          },
        },
        {
...
Chip.propTypes /* remove-proptypes */ = {
  ...
  /**
   * If `true`, shows a border using the color's `border` token.
   * @default false
   */
  ...
  /**
   * The semantic type of the chip. Maps to a palette color.
   * Takes precedence over `color` when set.
   * @default undefined
   */
