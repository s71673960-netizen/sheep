  ...
  memoTheme(({ theme }) => ({
    ...
    boxShadow:
      theme.palette.mode === 'dark'
        ...
        : '0 4px 16px rgba(70, 52, 32, 0.08)',
    scrollbarWidth: 'thin',
    scrollbarColor: 'var(--dialog-scrollbar-thumb) transparent',
    '&::-webkit-scrollbar': {
      width: 4,
      height: 4,
    },
    '&::-webkit-scrollbar-thumb': {
      backgroundColor: 'var(--dialog-scrollbar-thumb)',
      borderRadius: 4,
      '&:hover': {
        backgroundColor: 'var(--dialog-scrollbar-thumb-hover)',
      },
      '&:active': {
        backgroundColor: 'var(--dialog-scrollbar-thumb-active)',
      },
    },
