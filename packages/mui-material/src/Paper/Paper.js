...
const PaperRoot = styled('div', {
  ...
  memoTheme(({ theme }) => ({
    ...
    boxShadow: '0 0 1px 0 rgba(101, 94, 85, 0.20), 0 8px 16px 0 rgba(101, 94, 85, 0.08)',
    variants: [
      {
  ...
  return (
    <PaperRoot
      ...
      style={{
        ...(variant === 'elevation' && {
          '--Paper-shadow':
            theme.palette.mode === 'dark' && elevation > 0
              ? elevation >= 16
                ? '0 16px 48px rgba(0, 0, 0, 0.48)'
                : elevation >= 8
                  ? '0 12px 32px rgba(0, 0, 0, 0.42)'
                  : '0 8px 24px rgba(0, 0, 0, 0.32)'
              : (theme.vars || theme).shadows[elevation],
          '--Paper-overlay':
            theme.palette.mode === 'dark' ? 'none' : theme.vars?.overlays?.[elevation],
        }),
        ...other.style,
      }}
    />
