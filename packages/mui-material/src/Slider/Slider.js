...
export const SliderTrack = styled('span', {
  ...
  memoTheme(({ theme }) => {
    return {
      ...
      transition: 'left 0.3s, width 0.3s, bottom 0.3s, height 0.3s',
      variants: [
        {
          props: { orientation: 'horizontal' },
          style: {
...
export const SliderThumb = styled('span', {
  ...
  memoTheme(({ theme }) => ({
    ...
    transition: 'box-shadow 0.3s, left 0.3s, bottom 0.3s, width 0.3s, height 0.3s',
    '&::after': {
      position: 'absolute',
      content: '""',
      borderRadius: '50%',
    ...
    '&:hover, &:focus-visible': {
      width: 12,
      height: 12,
      boxShadow: `0 0 0 4px ${theme.alpha((theme.vars || theme).palette.primary.main, 0.12)}`,
    },
    [`&.${sliderClasses.active}`]: {
      width: 12,
      height: 12,
      boxShadow: `0 0 0 6px ${theme.alpha((theme.vars || theme).palette.primary.main, 0.16)}`,
    },
    [`&.${sliderClasses.disabled}`]: {
      '&:hover': {
        boxShadow: 'none',
    ...
    variants: [
      ...
      ...Object.entries(theme.palette)
        ...
        .map(([color]) => ({
          ...
          style: {
            '&:hover, &:focus-visible': {
              boxShadow: `0 0 0 4px ${theme.alpha((theme.vars || theme).palette[color].main, 0.12)}`,
            },
            [`&.${sliderClasses.active}`]: {
              boxShadow: `0 0 0 6px ${theme.alpha((theme.vars || theme).palette[color].main, 0.16)}`,
            },
          },
        })),
    ],
...
const SliderValueLabel = styled(BaseSliderValueLabel, {
  ...
  memoTheme(({ theme }) => ({
    ...
    boxShadow:
      theme.palette.mode === 'dark' ? '0 8px 24px rgba(0, 0, 0, 0.32)' : 'none',
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
    padding: '4px 8px',
